...
export const externalCourses: ExternalCourse[] = [
  {
    ...
    description: 'Master Microsoft Copilot to boost productivity in daily tasks with AI-powered assistance',
    url: 'https://www.coursera.org/specializations/microsoft-copilot-your-everyday-ai-companion',
    provider: 'Coursera',
    level: 'beginner',
  },
  {
    ...
    description: 'Get started with Microsoft Copilot and learn how to leverage AI in your workflow',
    url: 'https://www.coursera.org/learn/introduction-to-microsoft-copilot',
    provider: 'Coursera',
    level: 'beginner',
  },
  {
    id: 'ext-3',
    title: 'Introduction to Microsoft GitHub Copilot',
    description: 'Learn to use GitHub Copilot for AI-assisted coding and development',
    url: 'https://www.coursera.org/learn/introduction-to-microsoft-github-copilot#modules',
    provider: 'Coursera',
    level: 'intermediate',
  },
  {
    ...
    description: 'Master prompt engineering techniques to get the best results from GitHub Copilot',
  ...
  {
    id: 'ext-5',
    title: 'Generative AI for Insurance Agents',
    description: 'Comprehensive course on applying generative AI in insurance industry workflows',
    url: 'https://www.udemy.com/course/generative-ai-for-insurance-agents/',
    provider: 'Udemy',
    level: 'intermediate',
  },
  {
    id: 'ext-6',
    title: 'GenAI in Insurance: Automating Claims & Risk Mitigation',
    description: 'Learn to automate claims processing and risk assessment using generative AI',
    url: 'https://www.coursera.org/learn/genai-in-insurance-automating-claims--risk-mitigation',
    provider: 'Coursera',
    level: 'advanced',
  },
];
